...
if (isset($_POST["submit"]))
{
	...
	$query = "INSERT INTO agent(username,password,firstName,lastName,agentEmail,agentContact) values (?, ?, ?, ?, ?, ?)";
	...
	if($affected_rows == 1)
	{
		...
		mysqli_close($dbc);	
		echo '<br><br><a href="listagent.php">Click here</a>';
	}
	else
	{
